...
설명: 큐의 기본 연산(삽입, 삭제, 크기 확인, 비어있는지 확인, 맨 앞/뒤 요소 확인 등)을 직접 구현하는 문제입니다.
문제 링크: 큐
프린터 큐 (1966번)

설명: 큐를 사용하여 문서의 우선순위에 따라 문서를 출력하는 과정을 시뮬레이션하는 문제입니다.
문제 링크: 프린터 큐
데크 관련 문제
덱 (10866번)
설명: 덱의 기본 연산(push_front, push_back, pop_front, pop_back, size, empty, front, back 등)을 직접 구현하는 문제입니다.
문제 링크: 덱
