...
<img width="80%" alt="2" src="../../assets/img/ai_paper/nlpm/nplm_01.png">
...
<img width="80%" alt="3" src="../../assets/img/ai_paper/nlpm/nplm_02.png">

- count(A) / count(B)  =>    Multiply each probability value to obtain the word appearance probability

<img width="80%" alt="4" src="../../assets/img/ai_paper/nlpm/nplm_03.png"></p>
...
<img width="80%" alt="6" src="../../assets/img/ai_paper/nlpm/nplm_05.png">
...
<img width="80%" alt="7" src="../../assets/img/ai_paper/nlpm/nplm_04.png">
...
<img width="80%" alt="8" src="../../assets/img/ai_paper/nlpm/nplm_06.png"></p>
...
<img width="80%" alt="9" src="../../assets/img/ai_paper/nlpm/nplm_07.png"></p>
...
<img width="80%" alt="input" src="../../assets/img/ai_paper/nlpm/nplm_08.png">
...
<img width="80%" alt="hidden" src="../../assets/img/ai_paper/nlpm/nplm_09.png">

**Output**

<img width="80%" alt="output" src="../../assets/img/ai_paper/nlpm/nplm_10.png">

**Optional**

<img width="80%" alt="output" src="../../assets/img/ai_paper/nlpm/nplm_11.png">
...
<img width="80%" alt="output" src="../../assets/img/ai_paper/nlpm/nplm_12.png">
